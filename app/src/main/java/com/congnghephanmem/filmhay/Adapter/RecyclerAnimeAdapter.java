...
public class RecyclerAnimeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        /*try {
            Integer.parseInt(filmList.get(position).getImg().trim());
            Picasso.get().load(Integer.parseInt(filmList.get(position).getImg().trim())).into(myRecyclerAnimeHolder.img);
        }catch (Exception e){
            Picasso.get().load((filmList.get(position).getImg().trim())).into(myRecyclerAnimeHolder.img);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("idf", String.valueOf(filmList.get(position).getId()));
